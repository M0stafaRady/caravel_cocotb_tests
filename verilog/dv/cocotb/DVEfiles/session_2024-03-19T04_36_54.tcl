...
# DVE full session
# Saved on Tue Mar 19 04:36:54 2024
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 29} {2489 1352}}
...
gui_sg_addsignal -group "$_session_group_14" { caravel_top.uut.chip_core.soc.tck caravel_top.uut.chip_core.soc.tdi caravel_top.uut.chip_core.soc.tdo caravel_top.uut.chip_core.soc.tms caravel_top.uut.chip_core.soc.trap caravel_top.uut.chip_core.soc.trst caravel_top.clock_tb }
...
gui_marker_create -id ${Wave.1} C2 7787.5
